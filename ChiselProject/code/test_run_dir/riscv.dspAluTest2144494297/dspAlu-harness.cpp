...
#endif
#include <iostream>
class dspAlu_api_t: public sim_api_t<VerilatorDataWrapper*> {
public:
    dspAlu_api_t(VdspAlu* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.inputs.push_back(new VerilatorIData(&(dut->io_in_rs2)));
        sim_data.inputs.push_back(new VerilatorIData(&(dut->io_in_rs1)));
        ...
        sim_data.signal_map["dspAlu.reset"] = 0;
    }
#if VM_TRACE
...
static dspAlu_api_t * _Top_api;
double sc_time_stamp () { return _Top_api->get_time_stamp(); }
int main(int argc, char **argv, char **env) {
    Verilated::commandArgs(argc, argv);
    VdspAlu* top = new VdspAlu;
    std::string vcdfile = "test_run_dir/riscv.dspAluTest2144494297/dspAlu.vcd";
